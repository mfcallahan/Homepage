...
namespace Homepage
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // homepage style
            bundles.Add(new StyleBundle("~/Content/home-style").Include(
                "~/Content/home.css"));
            ...
            // radio style
            bundles.Add(new StyleBundle("~/Content/radio-style").Include(
                "~/Content/radio.css"));

            // map style
            bundles.Add(new StyleBundle("~/Content/map-style").Include(
                "~/Content/map.css"));
